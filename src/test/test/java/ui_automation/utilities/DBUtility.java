...
public class DBUtility {
    ...
    public static void openConnection() throws SQLException {
        ...
        connection = DriverManager.getConnection(ConfigurationReader.getProperty("ui-config.properties","mysql.url"),
                ConfigurationReader.getProperty("ui-config.properties","examplewebapp.database.username"),
                ConfigurationReader.getProperty("ui-config.properties","examplewebapp.database.password"));
        }
